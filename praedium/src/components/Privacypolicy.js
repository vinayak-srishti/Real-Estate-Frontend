        ...
        <div className="col-sm-6 col-md-9 g-4">
          ...
          <ol type="A">
            ...
            <ul style={{ listStyle: "disc" }}>
              <li>
                <b>Personal Details:</b> This includes your name, contact
                information (like addresses, e-mail addresses, phone number),
                and login information (like username).
              </li>

              <li>
                <b>Property Details:</b> This includes the details of the
                property such as nature the of property (like commercial,
              ...
              <li>
                <b>Payment Information:</b> We use third-party payment service
                providers to process your payments. You will be re-directed to a
                third-party interface which will collect the required
                information from you to process the payment transaction. The
                payment transaction will also be governed by the policies of
                such third-party service provider, including their privacy
                policy. We may receive certain transaction details from
                third-party payment service providers. However, we do not store
                and do not have access to your financial information such as
                your bank account numbers, credit/ debit card numbers, or UPI
                handle.
              </li>

              <li>
                <b>Communications Details:</b> This includes records of your
                calls, emails, messages or your communications in other forms
                related to any feedback, comments, queries, issue reports,
